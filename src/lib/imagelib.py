...
def resize_image(mode, im, width, height):
...
#
#     x = x.replace("[model_hash]", getattr(p, "sd_model_hash", src_plugins.sd1111_plugin.SDState.sdmodel.hash))
