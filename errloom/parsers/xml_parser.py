...
class XMLParser(Parser):
    ...
    def parse_answer(self, completion: MessageList | str) -> str | None:
    ...
    def get_format_attraction_rule(self) -> Callable:
        """
        Return an attraction rule that checks if messages follow the expected format.
        ...
        """
        def format_attraction_rule(completion):
            """Attraction rule that checks if each step follows the expected format."""
